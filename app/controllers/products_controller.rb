class ProductsController < ApplicationController
  ...
  def diff
    ...
    @products_diff = Product.where("coalesce((select sum(1) from line_items where line_items.product_id = products.id), 0) != (products.on_hand_qty - products.on_customer_order_qty)")
